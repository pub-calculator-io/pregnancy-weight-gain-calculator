...
Version: 1.0.0
Author: Pregnancy Weight Gain Calculator / www.calculator.io
...
function display_calcio_ci_pregnancy_weight_gain_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_pregnancy_weight_gain_calculator', 'display_calcio_ci_pregnancy_weight_gain_calculator' );